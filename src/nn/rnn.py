...
class RNN(nn.Module):
    def __init__(self, rnn = None, vocab_size=None, embedding_dim=EMBEDDING_DIM, pretrained_weights=None, n_layers=N_LAYERS, hidden_units=HIDDEN_UNITS, bidirectional=BIDIRECTIONAL, output_dim=None, dropout=DROPOUT, stylo_features = 0):
        super().__init__()
